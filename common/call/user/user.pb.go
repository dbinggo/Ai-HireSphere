...
var file_application_user_center_interfaces_rpc_user_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x53, 0x65, 0x78, 0x32, 0x60, 0x0a, 0x04, 0x55, 0x73, 0x65,
	...
	0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x08, 0x5a, 0x06, 0x2e,
...
var file_application_user_center_interfaces_rpc_user_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_application_user_center_interfaces_rpc_user_proto_depIdxs = []int32{
	...
	2, // 2: user.User.FindUserById:output_type -> user.UserInfo
	2, // 3: user.User.FindUserByPhone:output_type -> user.UserInfo
